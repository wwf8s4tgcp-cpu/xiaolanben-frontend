...
const restoreThemeColor = () => {
  ...
  // 设置默认主题色
    const root = document.documentElement
    root.style.setProperty('--primary-color', '#2b6ef0')
    root.style.setProperty('--primary-color-dark', '#1a4fa8')
    root.style.setProperty('--primary-color-shadow', 'rgba(43, 110, 240, 0.3)')
  }
}
