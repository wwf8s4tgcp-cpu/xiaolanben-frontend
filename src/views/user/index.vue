  ...
  <div class="content-container">
    <div class="user-info" v-if="userStore.isLoggedIn">
      <div class="basic-info">
        ...
        <div class="user-basic">
          ...
          <div class="user-content">
            <div class="user-id text-ellipsis">小蓝本号：{{ userStore.userInfo?.user_id || '' }}</div>
      ...
      <div class="theme-settings">
        <div class="theme-settings-label">主题模式</div>
        <div class="theme-options">
          ...
          >
            <SvgIcon :name="option.icon" width="20" height="20" />
    ...
    <div class="fixedTab" :class="{ hidden: scrollY < 100 }" ref="fixedTabBarRef" v-if="userStore.isLoggedIn">
    ...
    <div class="content-switch-container" v-if="userStore.isLoggedIn">
      ...
      <div class="content-item" :class="{ active: activeTab === 'posts' }"
        ...
        <div class="waterfall-container">
          <WaterfallFlow :userId="userStore.userInfo?.id" :type="'posts'" :refreshKey="refreshKeys.posts"
      ...
      <div class="content-item" :class="{ active: activeTab === 'collections' }"
        ...
        <div class="waterfall-container">
          <WaterfallFlow :userId="userStore.userInfo?.id" :type="'collections'"
