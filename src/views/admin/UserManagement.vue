...
const columns = [
  ...
  { key: 'user_id', label: '小蓝本号', type: 'user-link', sortable: false, maxLength: 15 },
...
const userFormFields = [
  { key: 'user_id', label: '小蓝本号', type: 'text', required: true, placeholder: '请输入小蓝本号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '小蓝本号', placeholder: '搜索小蓝本号' },
