...
const isLargeScreen = ref(window.innerWidth > BP_MEDIUM)
const showSidebar = ref(window.innerWidth > BP_LARGE)
...
function handleResize() {
    isLargeScreen.value = window.innerWidth > BP_MEDIUM
    showSidebar.value = window.innerWidth > BP_LARGE
}
                ...
                <div class="search-row" :class="{ 'large-screen': isLargeScreen, 'small-screen': !isLargeScreen }">
                    <div class="search-bar-container">
                        <div class="search-bar">
                            <input v-model="searchText" type="text" placeholder="搜索小蓝本" @keypress="handleKeyPress"
